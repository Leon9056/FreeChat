const CACHE="freechat-1.6.2-mega-fix";
const CORE=["./","./index.html","./style.css","./manifest.json","./config.js?v=1.6.2r1","./app.js?v=1.6.2r1","./icon.svg","./icon-192.png","./icon-512.png"];
