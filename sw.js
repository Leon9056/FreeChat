const CACHE="freechat-1.5.0-refined";
const CORE=["./","./index.html","./style.css","./manifest.json","./config.js?v=1.5.0r2","./app.js?v=1.5.0r2","./icon.svg","./icon-192.png","./icon-512.png"];
