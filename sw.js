const CACHE="freechat-1.6.0-for-you";
const CORE=["./","./index.html","./style.css","./manifest.json","./config.js?v=1.6.0r1","./app.js?v=1.6.0r1","./icon.svg","./icon-192.png","./icon-512.png"];
