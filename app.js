/* Conversa Live v2.4.2 — áudio/música melhores, animações fluidas, otimizações e correções de bugs */
...
/* FreeChat 2.4.2 — navegação por gesto no celular */
let mobileView=0;
...
function animateMainMenu(){const menu=document.getElementById("callMenu");if(!menu)return;menu.classList.remove("menu-enter");void menu.offsetWidth;menu.classList.add("menu-enter");setTimeout(()=>menu.classList.remove("menu-enter"),450)}
...
/* FreeChat 2.4.2 — Social, notificações e PWA */
...
/* FreeChat 2.4.2 — chat privado com fotos, vídeos e notificações */
...
/* FreeChat 2.4.2 — estabilidade global, rede e mobile polish */
(function(){
