/* Conversa Live v1.9.1 — 2FA por e-mail + UI/UX aprimorada */
...
$("messagesClose")?.addEventListener("click",()=>{$("messagesPanel").classList.add("hidden");activeFriendCode=null});
messageTimer=setInterval(()=>{if(activeFriendCode&&!$("messagesPanel")?.classList.contains("hidden"))loadMessages(false)},5000);
