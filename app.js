...
function startSocket(){
  ...
  socket.on("connect_error",err=>{const msg=String(err?.message||"");$("status").textContent="Servidor offline — tentando reconectar...";setConnectionLevel(0,msg?"Offline • "+msg:"Offline")});
