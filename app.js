/* Conversa Live v2.3.1 — áudio/música melhores, animações fluidas, otimizações e correções de bugs */
...
/* FreeChat 2.3.1 — navegação por gesto no celular */
let mobileView=0;
...
function setMobileView(view){
 ...
 if(view===2){$("friendsPanel")?.classList.remove("hidden");window.renderFriends?.();} else $("friendsPanel")?.classList.remove("hidden");
}
...
/* FreeChat 2.3.1 — chat privado com fotos, vídeos e notificações */
