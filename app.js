/* Conversa Live v2.0.6 — conexão robusta, UI/UX, amigos, DMs e música */
...
$("loginTab").onclick=()=>modeSet("login");$("registerTab").onclick=()=>modeSet("register");$("loginBtn").onclick=auth;
 ...
 window.refreshUnreadCounts=refreshUnreadCounts; window.conversaApi=api;
...
/* FreeChat 2.0.6 — mensagens diretas */
